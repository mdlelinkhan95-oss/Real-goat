...
const OWNER_ID = "100090895866311"; // তোমার ফেসবুক আইডি এখানে বসাও
  ...
  onStart: async function({ api, event, args }) {
    ...
    if (senderID !== OWNER_ID) {
      return api.sendMessage(
        "এইটা কি তোর বাপের command নাকি রে? 🤬 হুদাই kamla করতে আসছোস! এইটা শুধুমাত্র RAFI⚡ ভাই চালায়, বুঝছস? 🫡",
        threadID,
        messageID
      );
    }
