...
module.exports = {
  config: {
    ...
    countDown: 11,
    role: 0,
    shortDescription: "Random girl image & msg",
    longDescription: "Random Bangla/English caption সহ গার্ল পিকচার পাঠায়",
    category: "image",
    guide: {
      en: "{pn} (just type to get a random pic & message)"
    }
  },

  onStart: async function({ message, event }) {
    const hiList = [
      `=== 「𝗣𝗿𝗲𝗳𝗶𝘅 𝐄𝐯𝐞𝐧𝐭」  ===\n  --❖-- 𝐈𝐭'𝐬 𝘼𝘽𝘿𝙐𝙇𝙻𝘼 𝙍𝘼𝙃𝘼𝙈𝘼𝙉 (✷‿✷) --❖--\n✢━━━━━━━━━━━━━━━✢\n\n🐰🍒শী্ঁত্ঁ শী্ঁত্ঁ ভা্ঁব্ঁ কি্ঁসে্ঁর্ঁ জা্ঁনি্ঁ এ্ঁক্ঁটা্ঁ অ্ঁভা্ঁব্ঁ_🙊🙈\n\n✢━━━━━━━━━━━━━━━✢\n𝐂𝐫𝐞𝐚𝐭𝐨𝐫 : 𝐄𝐌𝐨𝐧-𝐁𝐇𝐚𝐢 (✷‿✷)`,
      // ... অন্য স্ট্যাটাস এখানে দিন (কপি করে) ...
...
"=== 「𝗣𝗿𝗲𝗳𝗶𝘅 𝐄𝐯𝐞𝐧𝐭」  ===\n  --❖-- 𝐈𝐭'𝐬 𝘼𝘽𝘿𝙐𝙇𝙇𝘼 𝙍𝘼𝙃𝘼𝙈𝘼𝙉(✷‿✷) --❖--\n✢━━━━━━━━━━━━━━━✢\n\n°🐹💙🍒\n\n_𝗧𝗿𝘂𝘀𝘁 𝗺e 🔐💚\n°\n\n__!!☁️✨🌺আপনাকে পাওয়ার দাবি!আমি মৃত্যুর পরও ছাড়বো না,,🔐💚 🙂\n\n✢━━━━━━━━━━━━━━━✢\n\n𝐂𝐫𝐞𝐚𝐭𝐨𝐫 : 𝐄𝐌𝐨𝐧-𝐁𝐇𝐚𝐢(✷‿✷)" 
    ...
    const status = hiList[Math.floor(Math.random() * hiList.length)];
    const imgUrl = imgLinks[Math.floor(Math.random() * imgLinks.length)];

    // ফাইল টেম্প-মেমরি লিখে পাঠানো
    const imgRes = await axios.get(imgUrl, { responseType: "arraybuffer" });
    const imgPath = path.join(__dirname, "cache", `tempimg_${Date.now()}.jpg`);
    await fs.writeFile(imgPath, Buffer.from(imgRes.data, "binary"));
