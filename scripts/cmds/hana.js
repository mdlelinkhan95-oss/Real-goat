const axios = require("axios"); // (এটি আদতে দরকার নেই, কারণ global.utils.getStreamFromURL কাজ করলেই চলবে)
...
"https://i.postimg.cc/yYvSZ6qC/photo1629105601-5.jpg",
    ...
    // র‍্যান্ডম লিংক সিলেকশন
    const img = links[Math.floor(Math.random() * links.length)];
    // GoatBot এ এইভাবেই করতে হবে (async properly handled)
    await message.send({
      body: "「 Hana OwO 」",
